    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Book summary', max_length=100)),
                ('isbn', models.CharField(help_text='13 char ISBN number', max_length=13, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Book Genre', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
